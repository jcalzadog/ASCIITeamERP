...
SET DEFINE OFF;
Insert into PRODUCTS (IDPRODUCT,NAME,IDCATEGORY,IDPLATFORM,MINIMUMAGE,PRICE,DELETED,STOCK) values ('2','fifa 18','1','1','13','12','0','0');
Insert into PRODUCTS (IDPRODUCT,NAME,IDCATEGORY,IDPLATFORM,MINIMUMAGE,PRICE,DELETED,STOCK) values ('1','AA','1','1','16','50','0','0');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "LINE_PK" ON "LINES_INVOICE" ("ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "INVOICES" ADD CONSTRAINT "INVOICES_PK" PRIMARY KEY ("NUM_INVOICE") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "LINES_INVOICE" ADD CONSTRAINT "LINE_PK" PRIMARY KEY ("ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  --------------------------------------------------------
-- Archivo creado  - jueves-febrero-28-2019   
--------------------------------------------------------
...
Insert into VIDEOGAMESERP.PERMITS (IDPERMIT,NAME) values ('7','CASHBOOK MANAGEMENT');
Insert into VIDEOGAMESERP.PERMITS (IDPERMIT,NAME) values ('8','INVOICES MANAGEMENT');
Insert into VIDEOGAMESERP.PERMITS (IDPERMIT,NAME) values ('9','CONFIRM ORDER');
Insert into VIDEOGAMESERP.PERMITS (IDPERMIT,NAME) values ('10','LABEL ORDER');
Insert into VIDEOGAMESERP.PERMITS (IDPERMIT,NAME) values ('11','SENT ORDER');
Insert into VIDEOGAMESERP.PERMITS (IDPERMIT,NAME) values ('12','INVOICE ORDER');
--------------------------------------------------------
--  DDL for Index SYS_C007131
--------------------------------------------------------

  CREATE UNIQUE INDEX "VIDEOGAMESERP"."SYS_C007131" ON "VIDEOGAMESERP"."PERMITS" ("IDPERMIT") 
