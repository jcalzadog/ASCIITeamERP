...
namespace ERP.Dominio.Gestores
{
        ...
        
    {
        ...
        public void readPlatforms()
        {
            ...
            data = conector.getData("SELECT L.NAME NAME, COUNT(P.IDPRODUCT) CUENTA FROM PLATFORMS L LEFT OUTER JOIN PRODUCTS P ON L.IDPLATFORM=P.IDPLATFORM WHERE L.DELETED=0 GROUP BY L.NAME ORDER BY L.NAME",
